/**
 * ParentCompleteProfileScreen.tsx â€” YourShikshak
        ...
        >
          ...
          >
            ...
            <View style={s.stepBadge}>
              <Text style={s.stepBadgeTxt}>STEP 3 OF 3 Â· PARENT</Text>
            </View>
          ...
          <Animated.View style={[s.card, { opacity: fadeAnim, transform: [{ translateY: slideAnim }] }]}>
            ...
            <View style={s.successBanner}>
              ...
              <Text style={s.successBannerTxt}>Account created â€” you're in! Add details to get matched faster.</Text>
            </View>
            ...
            <Text style={s.fieldHint}>
              What subjects does your child need help with? Any special requirements? (Optional â€” you can add this from your dashboard later.)
            </Text>
            ...
            <View style={s.notesBox}>
              ...
              <TextInput
                ...
                placeholder={"e.g. Need Maths & Science for CBSE Class 10, prefer evening slotsâ€¦"}
