...
// â”€â”€ Section reveal: fade + lift on mount, staggered â”€â”€
...
// â”€â”€ Skeleton block: gentle opacity pulse â”€â”€
        ...
        {loading ? (
          ...
          <Reveal delay={40} style={s.empty}>
            ...
            <Text style={s.emptySub}>
              ...
              shortly â€” they'll appear here automatically.
            </Text>
          </Reveal>
        ) : (
          <View style={s.stack}>
