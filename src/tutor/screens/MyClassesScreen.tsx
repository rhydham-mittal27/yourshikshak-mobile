...
export default function MyClassesScreen({ navigation, route }: Props) {
  ...
  // Per-card cycle state: classId â†’ selected cycle number
  ...
  return (
    <View style={s.root}>
      ...
      >
        ...
        {/* â”€â”€ White card body â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
        <View style={s.card}>
          {/* Status filter tabs */}
          ...
          {loading && (
            <View style={s.center}>
              ...
              <Text style={s.centerTxt}>Loading classesâ€¦</Text>
            </View>
          )}
