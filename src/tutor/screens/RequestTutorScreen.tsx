 ...
 *
 * Step 1 â†’ Student name  +  Board (from GET /options/BOARD)
 * Step 2 â†’ Grade         (from GET /options/GRADE?parent=boardId)
 *           Subjects      (multi-select, from GET /options/SUBJECT?parent=gradeId)
 * Step 3 â†’ Mode (3D perspective cards)  +  Days  +  Time slot
 * Step 4 â†’ Location / City (if offline/hybrid)  +  Budget  +  Notes
 *
 * Animations:
 *  â€¢ Step transitions : translateX slide Â±30 + opacity fade (160ms out / 300ms in)
 *  â€¢ Chip selection   : Animated.spring bounce  (0.91 â†’ 1.06 â†’ 1.0)
 *  â€¢ Mode cards       : perspective rotateY tilt on unselected card
 *  â€¢ Progress bar     : Animated.timing fill width
 *  â€¢ Field stagger    : each block fades+slides in with 40â€“60 ms stagger
 *  â€¢ Next button      : scale(0.97) on press
 */
...
const TIME_SLOTS = [
  { label: "Morning",    sub: "6 AM â€“ 9 AM"   },
  { label: "Forenoon",   sub: "9 AM â€“ 12 PM"  },
  { label: "Afternoon",  sub: "12 PM â€“ 5 PM"  },
  { label: "Evening",    sub: "5 PM â€“ 9 PM"   },
];

const BUDGETS = [
  "Under â‚¹500/mo",
  "â‚¹500 â€“ â‚¹1,000/mo",
  "â‚¹1,000 â€“ â‚¹2,000/mo",
  "â‚¹2,000+/mo",
];
...
// â”€â”€â”€ Chip â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€â”€ Stagger-in wrapper â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€â”€ Loading chips skeleton â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
const RequestTutorScreen = () => {
  ...
  // â”€â”€ Curriculum data â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  // â”€â”€ Submitter identity (read from stored auth) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  // â”€â”€ Load boards on mount â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  useEffect(() => {
    getOptions("BOARD")
  ...
  // â”€â”€ Load grades when board changes â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  // â”€â”€ Load subjects when grade changes â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  // â”€â”€ Load cities when step 3 is first reached â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  useEffect(() => {
  ...
  // â”€â”€ Step transition â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const reqId   = res?.data?.requestId ?? res?.data?._id ?? "â€”";
  ...
  const renderStep0 = () => (
    <View key={stepKey.current}>
      <FadeIn delay={0}>
        ...
        {userType === "STUDENT" ? (
          <Text style={f.helperTxt}>Auto-filled from your profile Â· cannot be changed</Text>
        ) : (
      ...
      <View key={stepKey.current}>
        {isOffline && (
          <>
            ...
            {/* Area â€” from Options (parent = city type string) */}
            {selectedCity && (
              <FadeIn delay={d2 - 30}>
        ...
        <FadeIn delay={d4}>
          ...
          <TextInput
            ...
            placeholder="Any specific requirements, learning goals, or preferencesâ€¦"
            placeholderTextColor={T.textDisabled}
            value={notes}
  ...
  return (
    ...
    >
      ...
      {/* â”€â”€ Dark gradient header â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
      <LinearGradient
      ...
      {/* â”€â”€ White card body â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
      <ScrollView
        style={s.scroll}
