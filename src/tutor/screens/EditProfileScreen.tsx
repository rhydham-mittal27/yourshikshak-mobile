...
// Compact labeled input â€” label sits inside the box above the value
const LabeledField = ({
  label,
  value,
  onChange,
...
// 2-column grid for locked fields â€” halves vertical space
const LockedGrid = ({
  fields,
}: {
...
// Locked field â€” masked row, tap to toggle reveal
const LockedField = ({
  label,
  value,
  flex,
...
// Curriculum Picker Modal â€” same pattern as RegisterScreen
...
// â”€â”€â”€ FSelect â€” single-value dropdown â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
const FSelect = ({
  label,
  options,
  value,
...
// â”€â”€â”€ ChipSelect â€” multi-value chip toggle â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
const ChipSelect = ({
  label,
  options,
  selected,
...
const EditProfileScreen = ({ navigation }: { navigation: Nav }) => {
  ...
  // Group the selected subjects into a Board â†’ Class â†’ Subjects tree
  const subjectTree = (() => {
    ...
    selectedSubjects.forEach((id) => {
      ...
      if (!bEntry.grades.has(gKey))
        bEntry.grades.set(gKey, {
          grade: grade ?? ({ _id: gKey, label: "â€”" } as Option),
          subs: [],
        });
    ...
    <View style={{ flex: 1, backgroundColor: "#f7f7f7" }}>
      ...
      >
        ...
        >
          ...
          {/* â”€â”€ Qualifications & Teaching â”€â”€ */}
          <View style={styles.card}>
            <SectionHeader
              icon="school-outline"
          ...
          <View style={styles.card}>
            ...
            <LabeledField
              ...
              value={bio}
              onChange={setBio}
              placeholder="Tell students about yourselfâ€¦"
              multiline
            />
...
// â”€â”€â”€ Select / ChipSelect Styles â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
const styles = StyleSheet.create({
  ...
  // â”€â”€ Scroll & Cards â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  // â”€â”€ Field label â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  fieldLabelRow: {
    flexDirection: "row",
    alignItems: "center",
    gap: 6,
  ...
  // â”€â”€ Locked field â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  lockedRow: {
    flexDirection: "row",
    alignItems: "center",
    backgroundColor: "#f7f7f7", // surface-soft â€” neutral, not purple
    borderRadius: 12,
    borderWidth: 1,
  ...
  // â”€â”€ Tag input â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  // â”€â”€ Subject picker â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  subjectPickerBtn: {
    flexDirection: "row",
    alignItems: "center",
    justifyContent: "space-between",
  ...
  // â”€â”€ Selected subjects tree (Board â†’ Class â†’ Subjects) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  // â”€â”€ LabeledField â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  labeledBox: {
    borderWidth: 1,
    borderColor: "#dee1e6",
    borderRadius: 12,
