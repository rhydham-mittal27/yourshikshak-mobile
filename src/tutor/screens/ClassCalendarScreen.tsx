...
// Mock sessions â€” replace with API
const MOCK_SESSIONS: Session[] = (() => {
  ...
  for (let i = 0; i < 8; i++) {
    ...
    results.push({
      ...
      note:
        i === 5
          ? "Rescheduled from Mon to Wed due to teacher unavailability"
          : undefined,
    });
    dayOffset += i % 2 === 0 ? 3 : 4;
  }
...
// â”€â”€â”€ Session Detail Modal â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
const SessionModal = ({
  ...
  const fmtDate = dateObj.toLocaleDateString("en-IN", {
    weekday: "long",
    day: "numeric",
    month: "long",
    year: "numeric",
  ...
  return (
    ...
    >
      <Animated.View style={[cc.overlay, { opacity: opacityAnim }]}>
        ...
        />
        <Animated.View
          style={[cc.sheet, { transform: [{ translateY: slideAnim }] }]}
        >
          {/* handle */}
          ...
          >
            ...
            <Text style={[cc.sheetBadgeTxt, { color: meta.color }]}>
              {meta.label}
            </Text>
          </View>
...
const ClassCalendarScreen = () => {
  ...
  const sessionsByDate = MOCK_SESSIONS.reduce<Record<string, Session[]>>(
    (acc, s) => {
      (acc[s.date] ??= []).push(s);
      return acc;
    },
      ...
      >
        ...
        {view === "month" ? (
              ...
              {cells.map((day, idx) => {
                ...
                return (
                  <TouchableOpacity
                    ...
                    style={cc.cell}
                    onPress={() =>
                      sessions[0] && setSelectedSession(sessions[0])
                    }
                  ...
                  >
                    <View
                      style={[
                        cc.cellInner,
                        isToday && cc.cellToday,
                        sessions.length > 0 && cc.cellHasSession,
                      ]}
                    >
                          ...
                          {sessions.slice(0, 3).map((s, i) => (
                            <View
                              ...
                              style={[
                                cc.dot,
                                {
                                  backgroundColor: STATUS_META[s.status].color,
                                },
                              ]}
                            />
                          ))}
            ...
            <View style={cc.legend}>
              {(
                Object.entries(STATUS_META) as [
                  SessionStatus,
                  (typeof STATUS_META)[SessionStatus],
                ][]
              ).map(([key, meta]) => (
                <View key={key} style={cc.legendItem}>
                  <View
                    style={[cc.legendDot, { backgroundColor: meta.color }]}
                  />
          ...
          <View style={cc.listWrap}>
            {MOCK_SESSIONS.sort((a, b) => a.date.localeCompare(b.date)).map(
              (s, i) => {
                ...
                return (
                  <TouchableOpacity
                    ...
                    style={[
                      cc.listItem,
                      { opacity: isPast && s.status === "CANCELLED" ? 0.5 : 1 },
                    ]}
                  ...
                  >
                    ...
                    <View style={cc.listConnectorWrap}>
                      <View
                        style={[cc.listDot2, { backgroundColor: meta.color }]}
                      />
                      {i < MOCK_SESSIONS.length - 1 && (
                        <View style={cc.listLine} />
                      )}
                    </View>
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          <Text
                            style={[cc.listBadgeTxt, { color: meta.color }]}
                          >
                            {meta.label}
                          </Text>
                        </View>
                      ...
                      <View
                        style={{ flexDirection: "row", gap: 12, marginTop: 5 }}
                      >
                        <View
                          style={{
                            flexDirection: "row",
