/**
 * TutorCompleteProfileScreen.tsx — YourShikshak
    ...
    <View style={u.fieldWrap}>
      <Pressable style={[u.fieldBox, { borderColor: open ? T.primary : error ? T.error : T.border, borderWidth: open ? 1.5 : 1 }]} onPress={() => setOpen(o => !o)}>
        ...
        <View style={[u.fieldInner, icon && { paddingLeft: 4 }]}>
          ...
          <Text style={[u.selectVal, !value && { color: T.textDisabled }]}>{value || "Select…"}</Text>
        </View>
...
const SearchableMultiSelect = ({ label, options, selected, onToggle, accent = T.primary, placeholder = "Search…", hint }: {
        ...
        >
          ...
          >
            ...
            <View style={s.stepBadge}>
              <Text style={s.stepBadgeTxt}>STEP 3 OF 3 · TEACHER — {STEPS[step].label.toUpperCase()}</Text>
            </View>
          ...
          <Animated.View style={[s.card, { opacity: fadeAnim, transform: [{ translateY: slideAnim }] }]}>
            ...
            {step === 0 && (
              <>
                ...
                <FInput label="Bio (optional)" value={form.bio} onChange={v => set("bio", v)} icon="document-text-outline" placeholder="A short intro about yourself…" multiline lines={3} />
